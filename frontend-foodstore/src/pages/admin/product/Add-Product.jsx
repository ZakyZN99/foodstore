...
return (
    <>
    <Navbar/>
    <div className="text-black pl-20 max-w-[1440px] mx-auto">
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="pl-[20px] pb-2 text-black">
                                        <select className="w-[100%] h-[50px]  border-[1px] p-2 " value={productCategory}
